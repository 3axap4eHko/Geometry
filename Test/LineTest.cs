...
namespace Test
{
    ...
    public class LineTest
    {
        ...
        {
            Assert.IsTrue(line3.IntersectLine(line4) == new Point(2.5, 2.5));
            Assert.IsNull(line0.IntersectLine(line1));
            Assert.IsTrue(line1.IntersectLine(line2).Equals(new Point(0, 0)));
        }
